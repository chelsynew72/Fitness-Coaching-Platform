      ...
      <main className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex h-12 items-center justify-center gap-3 border border-white/5 bg-zinc-950 text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:border-white/10 hover:text-white transition-colors">
